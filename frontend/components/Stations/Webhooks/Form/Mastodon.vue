    ...
    >
        <form-markup id="mastodon_details">
            ...
            <ul>
                ...
                <li>
                    {{
                        $gettext('Enter "Bitstreaming Radio Panel" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.')
                    }}
                </li>
            </ul>
            <p class="card-text">
