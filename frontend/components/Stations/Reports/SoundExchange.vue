        ...
        >
            <div class="card-body">
                <form-fieldset>
                    ...
                    <ul>
                        <li>
                            Bitstreaming Radio Panel assumes that your station fits SoundExchange Transmission Category A, "Eligible
                        ...
                        <li>
                            The data collected by Bitstreaming Radio Panel meets the SoundExchange standard for Actual Total
                        ...
                        <li>
                            Reporting requirements for SoundExchange may change at any time. Bitstreaming Radio Panel is non-commercial
                            community-built software and cannot guarantee that its reporting format will always be
                            up-to-date.
                        </li>
                        <li>
                            You should always verify the report generated by Bitstreaming Radio Panel before sending it. In particular,
                ...
                <form-fieldset class="row">
                    ...
                    >
                        ...
                        <template #description>
                            {{
                                $gettext('If enabled, Bitstreaming Radio Panel will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.')
                            }}
                        </template>
                    </form-group-checkbox>
                </form-fieldset>
