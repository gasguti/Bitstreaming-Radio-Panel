                ...
                <div class="row g-3">
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <p class="card-text">
                                {{
                                    $gettext('Stereo Tool is not free software, and its restrictive license does not allow Bitstreaming Radio Panel to distribute the Stereo Tool binary.')
                                }}
                            </p>
...
const langInstalledVersion = computed(() => {
    return $gettext("Stereo Tool version %{version} is currently installed.", {
