<template>
    ...
    >
        <form-fieldset>
            <template #label>
                {{ $gettext('Bitstreaming Radio Panel Update Checks') }}
            </template>
            ...
            <div class="row g-3">
                ...
                >
                    <template #description>
                        <a
                            ...
                            target="_blank"
                        >
                            {{ $gettext('Learn more about release channels in the Bitstreaming Radio Panel docs.') }}
                        </a>
                    </template>
                ...
                <form-group-checkbox
                    ...
                    :description="$gettext('Show new releases within your update channel on the Bitstreaming Radio Panel homepage.')"
                />
            </div>
        </form-fieldset>
        ...
        <form-fieldset>
            ...
            <div class="row g-3">
                <form-group-field
                    ...
                    :description="$gettext('All listed domain names should point to this Bitstreaming Radio Panel installation. Separate multiple domain names with commas.')"
                />
